...
<div id="mainBody">
 ...
 <form:form action="/news-admin/delNews" modelAttribute="newsVO1">
		<c:forEach var="parseNews" items="${newsVO}">
			<div id="newsTitleDiv">
				<c:out value="${parseNews.news.newsTitle}" />
			</div>
			...
			<div id="newsShortTextDiv">
				<c:out value="${parseNews.news.newsShortText}" />
			</div>
			<br>
			<%-- <div id="linkReadMoreDiv">
				<a href="/news-admin/editSingleNews?&newsId=${parseNews.news.newsId}"><spring:message
						code="local.button.editAdmin" /></a>
						
			</div> --%>
			
			<div id="linkReadMoreDiv">
				<a href="/news-admin/editSingleNews?&newsId=${parseNews.news.newsId}">
